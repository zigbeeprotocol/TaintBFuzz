...
class cil_printer () = object (self)
  ...
  *)
  ...
  method storage fmt = function
	...
	| Intrinsic -> fprintf fmt "%a " self#pp_keyword "__intrisic"
  
  method nounwind fmt = function
    | Nounwind -> fprintf fmt "__nounwind"

  method noreturn fmt = function
    | Noreturn -> fprintf fmt "__noreturn"
