...
def s_random(value, min_length, max_length, num_mutations=25, fuzzable=True, step=None, name=None, oct_string=False):
    """
    ...
    :type  name:          str
    :param name:          (Optional, def=None) Specifying a name gives you direct access to a primitive
    :type  oct_string:    bool
    :param oct_string:    (Optional, def=False) Specifying if is a special type of string
    """

    random_data = primitives.RandomData(value, min_length, max_length, num_mutations, fuzzable, step, name, oct_string)
...
def s_string(value, size=-1, padding=b"\x00", encoding="ascii", fuzzable=True, max_len=0, name=None, types=None):
    """
    ...
    :param name:     (Optional, def=None) Specifying a name gives you direct access to a primitive
    :type  types:     str
    :param types:     (Optional, def=None) Specifying if is a special type of string
    """

    s = primitives.String(value, size, padding, encoding, fuzzable, max_len, name, types)
...
def s_byte(
    value, endian=LITTLE_ENDIAN, output_format="binary", signed=False, full_range=False, fuzzable=True, name=None, values=None
):
    """
    ...
    :param name:          (Optional, def=None) Specifying a name gives you direct access to a primitive
    :type values:           values
    :param values:          (Optional, def=None) Specifying a list of values for the fuzz library
    """

    byte = primitives.Byte(value, endian, output_format, signed, full_range, fuzzable, name, values)
...
def s_word(
    ...
    word = primitives.Word(value, endian, output_format, signed, full_range, fuzzable, name, values)
