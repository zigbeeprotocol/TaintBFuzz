...
class String(BasePrimitive):
    ...
    def __init__(self, value, size=-1, padding=b"\x00", encoding="ascii", fuzzable=True, max_len=-1, name=None, types=None):
        """
    ...
    def mutate(self):
        ...
        while 1:
            ...
            # generate special string based Zigbee spec
            if self.types == "oct_str":
                rand_len = random.randint(1, self.size)
                self._value = str(rand_len) + self._value
